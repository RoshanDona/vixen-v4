...
def harryresults():
    ok_file_path = '/sdcard/VIXEN/VIXEN-OK.txt'
    cp_file_path = '/sdcard/VIXEN/VIXEN-CP.txt'
...
def contact():
	os.system('https://www.facebook.com/roshan.thokar.686')
...
def setting():
	...
	scp += input(' \x1b[38;5;196m[\x1b[37m•\x1b[38;5;196m]\x1b[37m SHOW CP : ')
	passwrd()
	exit() 
