...
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          VIXENS BRAND
...
class __xxx__:
    ...
    def sarfrazx(self,id):
        os.system("clear")
        print(logo)
        self.cnt = input('Put File Name Example /sdcard/vixen.txt : ')
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m\rUSE WI-FI ONLY (5G ALSO BEST)\033[1;37m")
            print(47*"-")
